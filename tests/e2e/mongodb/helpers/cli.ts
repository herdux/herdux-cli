...
import { MONGODB_HOST, MONGODB_PORT } from "./docker.js";
...
/**
 * Runs the herdux CLI as a child process against the integration MongoDB container.
  ...
  const result = await execa(
    ...
    ["tsx", ENTRY_POINT, ...connectionArgs, ...args],
    {
      ...
      env: {
        ...
        HOME: resolve(PROJECT_ROOT, "tests", "e2e", "mongodb", ".tmp-home"),
      },
      timeout: 30_000,
    },
  );
